...
import 'package:patient_data_mobileapp/Medical%20Records/patienthistoryofrecord.dart';

// ignore: camel_case_types, must_be_immutable
class HistoryOfRecord extends StatelessWidget {
  HistoryOfRecord({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => RecordsHistory(
                                  index,
                                  getID,
                                  name,
                                  address,
...
class RecordsHistory extends StatelessWidget {
  final int index;
  final String getID;
  String name;
  String address;
